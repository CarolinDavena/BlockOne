 ...
 * This file demonstrates how to integrate Blockone with a web frontend
 */

// For React/Vue/Angular applications
export class BlockoneClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new BlockoneClient(provider, contractAddress);
